...
public:
  ...
  RobotArm() 
  {
    ...
    traj_client_ = new TrajClient("jaco_gripper_controller/joint_trajectory_action", true);
  ...
  */
  pr2_controllers_msgs::JointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.joint_names.push_back("jaco_finger_joint_1");
    goal.trajectory.joint_names.push_back("jaco_finger_joint_2");
    goal.trajectory.joint_names.push_back("jaco_finger_joint_3");
