...
typedef struct _DESCRIPTOR_INFO {
	USHORT wIndex;				// 
	UCHAR bManufacturer[64];		// manufacturer device
	UCHAR bDescriptor[64];			// Description device
...
typedef struct _INTERFACE_INFO {
	...
	_ENDPOINT_INFO Endpoints[32];	// placeholder for array of endpoint info structures
...
typedef struct _CONFIGURATION_INFO {
	...
	_INTERFACE_INFO Interfaces[4];	// placeholder for array of interface info structures
...
typedef struct _DEVICE_INFO {
    ...
    USHORT idProduct;
    USHORT bcdDevice;
	_CONFIGURATION_INFO Configurations[4];	// placeholder for array of configuration info structures
...
typedef struct _SET_CONFIGURATION_PARAMETER {
	...
	struct _Interfaces {
		...
		} Interfaces[4];		// placeholder for array of interface specifications
